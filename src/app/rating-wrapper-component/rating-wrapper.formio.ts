...
import { RatingWrapperComponent } from './rating-wrapper-component.component';

const COMPONENT_OPTIONS: FormioCustomComponentInfo = {
  type: 'myrating', // custom type. Formio will identify the field with this type.
  selector: 'app-rating-wrapper', // custom selector. Angular Elements will create a custom html tag with this selector
